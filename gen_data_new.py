...
DATASET_ROOT = Path('/project/ricky/splatformer-data-new')
...
def cleanup_scene_models(split_name, resolutions, obj_id):
    for resolution in resolutions:
        scene_output_dir = (
            split_root(split_name, resolution) / 'nerfstudio' / obj_id
        )
...
def main():
    ...
    for obj_path in glb_paths:
        ...
        for resolution in args.resolutions:
            ...
            output_dir = resolution_root / 'nerfstudio'
            ...
            try:
                ...
                if 'Invalid shape for means3d' in output:
                    print(
                        f'[CLEANUP] Removing nerfstudio outputs for {obj_id}'
                    )
                    print(
